...
const ParcelForm = ({
    ...
    const { ProductType, Prohibiteditem, itemType, productGroup } = fetchedFormData
    ...
    const handleSelect = (preset) => {
        ...
        if (preset === "A4 Envelope") {
            ...
            updateFields({ preset: selectedPreset, productHeight: "1", productWidth: "9", productLength: "12" })
        }
        else if (preset === "Small children Appliance") {

            updateFields({ preset: selectedPreset, productHeight: "13", productWidth: "15", productLength: "18" })
        }
        else if (preset === "Moving Box") {

            updateFields({ preset: selectedPreset, productHeight: "18", productWidth: "18", productLength: "30" })
        }
        ...
        <>
            <div>
                <Modal show={isModalOpen} onClose={handleCloseModal}>
                    ...
                    <div>
                        <div className="text-2xl font-semibold mb-3">Prohibited Items list</div>
                        {
                            Prohibiteditem?.map((item) => <div key={item.id} className="my-1">{item.id}. {item.itemName}</div>)
                        }
                    </div>
                </Modal>
            </div>
            ...
            <FormWrapper title="Parcel Details">
                <div className="flex w-full sender-form-container my-10 items-start">
                    <div className="flex flex-col justify-center w-full mr-4">
                        ...
                        <button type="button" onClick={handleOpenModal} className="prohibited-btn self-start items-center mt-3 text-[1rem] underline font-semibold flex">
                    ...
                    >
                        <option value={""} disabled selected hidden>Select item types</option>
                        {
                            itemType?.map(item => <option value={item.name} key={item.id}>{item.name}</option>)
                        }
                    ...
                    <div className="w-full mb-4 mb:mb-0 border-0 outline-none mr-4 flex items-center">
                        ...
                        <div className="mr-4">
                            <input
                                ...
                                required
                            />
                            <label htmlFor="package1" className="ml-2">Yes</label>
                        </div>
                        <div className="ml-4 flex items-center">
                            <input
                                ...
                                required
                            />
                            <label htmlFor="package2" className="ml-2">No</label>
                        </div>
                    </div>
                    {/* 
                ...
                <div className="mt-16">
                    ...
                    <div className="preset-wrapper">
                        <label
                            className={`preset-container flex items-center justify-around p-3 rounded-lg cursor-pointer border-2 ${preset === 'A4 Envelope' ? 'selected' : 'border-transparent'
                                }`}
                        ...
                        <label
                            className={`preset-container flex items-center justify-around p-3 rounded-lg cursor-pointer border-2 ${preset === 'Small children Appliance' ? 'selected' : 'border-transparent'
                                }`}
                        ...
                        <label
                            className={`preset-container flex items-center justify-around p-3 rounded-lg cursor-pointer border-2 ${preset === 'Moving Box' ? 'selected' : 'border-transparent'
                                }`}
                ...
                <div className="dimension-wrapper flex items-center w-full mt-16">
                    ...
                    <div className="w-full md:ml-4">
                        <div className="text-3xl font-semibold mt-8 md:mt-0 mb-3">Dimensions</div>
                ...
                <h1 className="mt-2 mb-10 text-red-500 text-base"><span className="text-red-700 font-bold text-lg">Please note:</span> Less than 1 kg, you can use decimals (e.g., 0.5 kg)</h1>
